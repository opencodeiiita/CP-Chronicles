//https://codeforces.com/problemset/submission/580/356767905
...
void dfs(int node,vi &a,vvi &adj,vi &visit,int m,vi &cat)
{
    int f=0,f2=0;
    visit[node]=1;
    for(auto i:adj[node])
